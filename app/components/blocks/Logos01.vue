...
<template>
  <section class="border-y bg-muted/30">
    <div class="mx-auto max-w-6xl px-6 py-14">
      <p class="text-muted-foreground text-center text-xs font-medium uppercase tracking-widest">
        Trusted by teams at
      </p>
      <div
      ...
      >
        <div
          v-for="logo in LOGOS"
          :key="logo.label"
          class="text-foreground/55 hover:text-foreground inline-flex items-center gap-2 transition-colors"
        >
          <svg
            viewBox="0 0 24 24"
