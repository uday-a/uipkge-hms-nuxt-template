...
<template>
  <div :class="cn('flex items-center gap-0.5', align === 'right' && 'justify-end', align === 'center' && 'justify-center', props.class)">
    <button
    ...
    >
      ...
      >
            ...
            <CommandGroup>
              ...
              >
                <CommandItem
                  ...
                  @select="filter.type === 'multiselect' ? toggleMultiselect(resolveOption(opt).value) : selectOne(resolveOption(opt).value)"
                >
                  <div
                    ...
                    :class="
                      cn(
                        ...
                        (Array.isArray(filterValue) ? filterValue : []).includes(resolveOption(opt).value)
        ...
        <div
          ...
          class="p-2"
        >
          <RangeCalendar v-model="dateModel" />
